...
package org.rapidpm.event.javaone.chap05.staticvirtual;
  ...
  private void addProxiedMethod(PrintWriter out, Method m) {
    ...
    if (returnType == void.class) out.printf(");%n }%n");
      ...
      if (!returnType.isPrimitive() && !returnType.isArray() && !aFinal) {
        ...
        final String proxyGenerator = "org.rapidpm.event.javaone.chap05.staticvirtual.ProxyGenerator";
        final String concurrency = "org.rapidpm.event.javaone.chap05.staticvirtual.Concurrency";
